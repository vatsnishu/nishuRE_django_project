...
def contact(request):
    if request.method == 'POST':
        ...
        contact = Contact(listing=listing, listing_id=listing_id, name=name, email=email, phone=phone, message=message, user_id=request.user.id, realtor_email=realtor_email)
